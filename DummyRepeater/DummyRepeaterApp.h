...
public:
	...
	virtual void getBleep(BLEEP_TYPE& bleepType, BLEEP_MODE& bleepMode, unsigned int& volume) const;
	virtual void setBleep(BLEEP_TYPE bleepType, BLEEP_MODE bleepMode, unsigned int volume) const;
