...
CDVMEGAAMBEThread::CDVMEGAAMBEThread(CDVMEGAAMBEController* dongle) :
CDongleThread(),
m_dongle(dongle),
m_wantMode(A3_IDLE),
m_mode(A3_IDLE),
...
CDVMEGAAMBEThread::~CDVMEGAAMBEThread()
{
}

bool CDVMEGAAMBEThread::open()
{
...
void CDVMEGAAMBEThread::setDecode()
{
...
void CDVMEGAAMBEThread::setEncode()
{
...
void CDVMEGAAMBEThread::setIdle()
{
	m_wantMode = A3_IDLE;
}

void CDVMEGAAMBEThread::processDecodeIn()
{
...
void CDVMEGAAMBEThread::processDecodeOut()
{
...
void CDVMEGAAMBEThread::processEncodeIn()
{
	if (m_packets >= MAX_PACKETS)
		return;
...
void CDVMEGAAMBEThread::processEncodeOut()
{
	unsigned char ambe[VOICE_FRAME_LENGTH_BYTES];
